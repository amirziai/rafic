...
#
#
# class StanfordCarDataset(dataset.Dataset):
#     """Stanford Car dataset for meta-learning.
#
...
#     """
#
#     _BASE_PATH = "./stanford_car_dataset"
#     if os.path.isdir("./src"):
#         _BASE_PATH = "./src/stanford_car_dataset"
#     # _GDD_FILE_ID = '...'
#
#     def __init__(self, num_support, num_query):
#         """Inits StanfordCar dataset.
#
#         Args:
...
#         super().__init__()
#
#         # if necessary, download the StanfordCar dataset
...
#         self._character_folders = glob.glob(os.path.join(self._BASE_PATH, "*/*/"))
...
#
#
# class StanfordCarSampler(sampler.Sampler):
#     """Samples task specification keys for an StanfordCar dataset."""
#
#     def __init__(self, split_idxs, num_way, num_tasks):
#         """Inits StanfordCarSampler.
#
#         Args:
...
#
#
# def get_stanford_car_dataloader(
#     split,
#     batch_size,
#     num_way,
#     num_support,
...
#     num_workers=2,
# ):
#     """Returns a dataloader. DataLoader for Stanford Cars Dataset.
#
#     Args:
...
#         dataset=StanfordCarDataset(num_support, num_query),
#         batch_size=batch_size,
#         sampler=StanfordCarSampler(split_idxs, num_way, num_tasks_per_epoch),
